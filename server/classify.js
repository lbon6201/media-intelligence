...
const CLASS_SYS_BASE = [
  ...
  '  "institutional_investor_quotes": array of {source, quote, stance} where stance is bullish|bearish|neutral|cautious. Only named people at institutional investors (pension funds, endowments, insurers, sovereign wealth funds, asset managers). IMPORTANT: Only include quotes that are specifically about the workstream topic. Exclude quotes about unrelated subjects.',
  '  "external_quotes": array of {source, role, quote, stance} where role is one of: regulator (SEC commissioners, FSOC members, bank regulators) | legislator (Congress members, committee chairs, Hill staffers) | academic (professors, researchers, think tank fellows) | rating_agency (Moody\'s, S&P, Fitch analysts) | trade_group (industry association spokespeople) | legal_expert (lawyers, compliance officers, legal analysts) | industry_executive (CEOs, CIOs, portfolio managers at firms) | former_official (former regulators, ex-government) | journalist (when a journalist is quoted as commentator, not as author) | analyst (sell-side analysts, research analysts, strategists) | investor_advocate (consumer groups, investor protection orgs) | other. Stance is positive|neutral|negative. Non-institutional-investor voices only. IMPORTANT: Only include quotes that are specifically about the workstream topic. Exclude quotes about unrelated subjects.',
