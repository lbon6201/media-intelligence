...
const CLASS_SYS_BASE = [
  ...
  '  "institutional_investor_quotes": array of {source, quote, stance} where stance is bullish|bearish|neutral|cautious. Only named people at institutional investors — the LPs who invest in funds: pension funds, endowments, insurers, sovereign wealth funds, asset managers. IMPORTANT: Only include quotes specifically about the workstream topic.',
  '  "internal_quotes": array of {source, role, quote, stance} where role is one of: fund_executive (C-suite, partners, MDs at private credit firms) | portfolio_manager (investment professionals at funds) | spokesperson (official firm communications, IR) | trade_association (AIC, MFA, industry group leaders). Stance is supportive|defensive|neutral. These are people who work AT the private credit firms or their trade associations.',
  '  "external_quotes": array of {source, role, quote, stance} where role is one of: regulator (SEC commissioners, FSOC members, bank regulators) | legislator (Congress members, committee chairs, Hill staffers) | academic (professors, researchers, think tank fellows) | rating_agency (Moody\'s, S&P, Fitch analysts) | legal_expert (lawyers, compliance officers, legal analysts) | former_official (former regulators, ex-government) | journalist (when a journalist is quoted as commentator, not as author) | analyst (sell-side analysts, research analysts, strategists) | investor_advocate (consumer groups, investor protection orgs) | other. Stance is positive|neutral|negative. These are voices OUTSIDE the industry — not fund employees and not institutional investors. IMPORTANT: Only include quotes specifically about the workstream topic.',
