...
if (IS_POSTGRES) {
  ...
  // Auto-create tables on startup (each statement separately for pg compatibility)
  const tables = [
  ...
  migrateTable('articles', [
    ...
    ['cl_external_quotes', 'TEXT'], ['cl_internal_quotes', 'TEXT'], ['cl_key_takeaway', 'TEXT'],
