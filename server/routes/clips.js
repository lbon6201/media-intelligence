...
router.post('/:workstream_id/generate', async (req, res) => {
  ...
  for (const a of articles) {
    ...
    a.cl_firms_mentioned = normalizeFirmList(safeParseJson(a.cl_firms_mentioned) || []);
    a.cl_firm_sentiments = normalizeFirmSentiments(safeParseJson(a.cl_firm_sentiments) || {});
